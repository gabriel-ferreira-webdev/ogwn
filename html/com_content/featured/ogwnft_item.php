...
<div class="feed-post-thumb">
	<a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid, $this->item->language)); ?>" itemprop="url" class="feed-post-thumb-a" style="background-image: url(<?php echo $images->image_intro;?>);"></a>
</div>
